...
## Included Binaries
- **`ZenoSSH-Windows.exe`**: Interactive GUI version with a modern split-pane SFTP browser and the verified Zeno icon.
- **`ZenoSSH-CLI.exe`**: Command-line automation version with the same verified Zeno icon.
